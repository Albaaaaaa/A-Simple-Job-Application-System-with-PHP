...
<head>
<meta charset="utf-8">
<title>D'Lokerz / <?php echo $title;?></title>
...
<style type="text/css">
  ...
  .pull-right.login {
    margin-right: 20px; /* Sesuaikan dengan berapa jauh kamu ingin menggeser teks ke kiri */
}
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>WhatsApp (+62) 895631667060</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">D'LOKERZ<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Pekerjaan Populer <b class="caret"></b></a>
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring">Rekrut Sekarang</a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='About'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=About">Tentang Projek</a></li>
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='Contact'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=Contact">Kontak Kami</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <address>
          <strong>D'Lokerz</strong><br>
          Samarinda, Samarinda Kota, Gunung Kelua<br>
           Kalimantan Timur, Indonesia</address>
          <p>
            <i class="icon-phone"></i> WhatsApp (+62) 895631667060 <br>
            <i class="icon-envelope-alt"></i> barudakptl@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          <h5 class="widgetheading">Akses</h5>
          <ul class="link-list">
            <li><a href="<?php echo web_root; ?>index.php">Home</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=company">Perusahaan</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=hiring">Cari Kerja Langsung</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=About">Tentang Projek</a></li>
            <li><a href="<?php echo web_root; ?>index.php?q=Contact">Kontak Kami</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
