...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>D'LOKERZ</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>D'LOKERZ</b></span>
    </a>
          ...
          <li class="dropdown user user-menu" style="padding-right: 15px;"  >
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo web_root.'admin/user/index.php?view=view&id='.$_SESSION['ADMIN_USERID'] ;?>" class="btn btn-default btn-flat">Profil</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo web_root ;?>admin/logout.php" class="btn btn-default btn-flat">Keluar</a>
                </div>
              </li>
            </ul>
          </li>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'vacancy') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/vacancy/">
            <i class="fa fa-suitcase"></i> <span>Lowongan</span> 
          </a>
        </li>
        ...
        <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/category/">
            <i class="fa fa-list"></i> <span>Kategori Pekerjaan</span>  
          </a>
        </li> 
       <!--  <li class="treeview">
          <a href="#">
         ...
         <li class="<?php echo (currentpage() == 'user') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>admin/user/">
            <i class="fa fa-user"></i> <span>Pengelola</span> </a>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>RPL &copy; 2024 <a href="#">KELOMPOK 3</a>.</strong> Project UAS
