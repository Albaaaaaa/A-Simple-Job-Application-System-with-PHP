 ...
 <section id="feature" class="transparent-bg">
        <div class="container">
           <div class="center wow fadeInDown">
                 <h2 class="page-header">Tambah Karyawan Baru</h2>
                        ...
                        <div class="col-md-8">
                          <input name="deptid" type="hidden" value="">
                           <input class="form-control input-sm" id="FNAME" name="FNAME" placeholder=
                              "Masukan Nama Depan" type="text" value=""   autocomplete="off">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8">
                          ...
                          <input  class="form-control input-sm" id="LNAME" name="LNAME" placeholder=
                              "Masukan Nama Belakang"     autocomplete="off">
                          </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-8">
                          ...
                          <input  class="form-control input-sm" id="MNAME" name="MNAME" placeholder=
                              "Masukan Nama Tengah"     autocomplete="off">
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         ...
                         <textarea class="form-control input-sm" id="ADDRESS" name="ADDRESS" placeholder=
                            "Masukan Alamat" type="text" value="" required   autocomplete="off"></textarea>
                      </div>
                    </div>
                  </div> 
                              ...
                              <div class="col-md-8">
                                <div class="input-group">
                                    <span class="input-group-addon"> 
                                     ...
                                     <input class="form-control input-sm date_picker" id="BIRTHDATE" name="BIRTHDATE" placeholder="Masukan Tanggal Lahir" type="text"    value="" required  autocomplete="off">
                                </div>
                              </div>
                            </div>
                          </div>
                                ...
                                <div class="col-md-8">
                                  ...
                                  <div class="col-md-8">
                                     ...
                                     <textarea class="form-control input-sm" id="BIRTHPLACE" name="BIRTHPLACE" placeholder=
                                        "Masukan Tempat Lahir" type="text" value="" required   autocomplete="off"></textarea>
                                  </div>
                                </div>
                              </div> 
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
                                      "Masukan Kontak." type="text" any value="" required   autocomplete="off">
                                </div>
                              </div>
                            </div> 
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="POSITION" name="POSITION" placeholder=
                                      "Masukan Posii" type="text" any value="" required   autocomplete="off">
                                </div>
                              </div>
                            </div>  
                        ...
                        <!--     <div class="form-group">
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   <input type="Email" class="form-control input-sm" id="EMP_EMAILADDRESS" name="EMP_EMAILADDRESS" placeholder="Masukan Alamat Email"   autocomplete="false"/> 
                                </div>
                              </div>
                            </div>  
