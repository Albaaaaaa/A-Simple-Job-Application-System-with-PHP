...
<div class="panel-body inf-content">
    <div class="row">
        ...
        <div class="col-md-6">
            <h1><strong>Profil Pengguna</strong></h1><br>
             <form class="form-horizontal span6" action="controller.php?action=edit&view=" method="POST">
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder=
                            "Nama Lengkap" type="text" value="<?php echo $singleuser->FULLNAME; ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "U_USERNAME">Nama Pengguna:</label>

                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                            "Nama Pengguna" type="text" value="<?php echo $singleuser->USERNAME; ?>">
                      </div>
                    </div>
                  </div>
              ...
              <div class="modal-content">
                ...
                <form action="controller.php?action=photos" enctype="multipart/form-data" method="post">
                  ...
                  <div class="modal-footer">
                    <button class="btn btn-default" data-dismiss="modal">Tutup</button> <button class="btn btn-primary"
