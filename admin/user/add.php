 ...
 <form class="form-horizontal span6" action="controller.php?action=add" method="POST">
                   ...
                   <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for="U_NAME">Nama:</label>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" minlength="2" value="">
                         <input class="form-control input-sm" id="U_PASS" min="3" name="U_PASS" placeholder="Kata Sandi" type="Password" value="" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
