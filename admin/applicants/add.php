 ...
 <section id="feature" class="transparent-bg">
        <div class="container">
           <div class="center wow fadeInDown">
                 <h2 class="page-header">Tambah Pelamar Baru</h2>
                ...
                <div class="features">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-8">
                         ...
                         <div class="form-group">
                             ...
                             <div class="form-group">
                                <div class="col-md-8">
                                  <label class="col-md-4 control-label" for=
                                  "BIRTHPLACE">Tempat tanggal lahir:</label>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                         <button class="btn btn-primary btn-sm" name="save" type="submit" ><span class="fa fa-save fw-fa"></span> Simmpan</button>
