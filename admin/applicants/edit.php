...
// $res = $autonum->single_autonumber(2);
 ...
 ?> 
       ...
       <div class="center wow fadeInDown">
             <h2 class="page-header">Perbarui Pekerja</h2>
                  ...
                  <div class="form-group">
                      <div class="rows">
                        <div class="col-md-8">
                          <h4>
                          <div class="col-md-4">
                            <label class="col-lg-12 control-label">Tangal Lahir</label>
                          </div>
                    ...
                    <div class="form-group">
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="POSITION" name="POSITION" placeholder=
                                      "Posisi" type="text" any value="<?php echo $emp->POSITION;?>" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <div class="col-md-8">
                                <label class="col-md-4 control-label" for=
                                "DATEHIRED">Tanggal Dipekerjakan:</label>
