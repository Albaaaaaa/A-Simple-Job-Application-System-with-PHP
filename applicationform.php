                     ...
                     <div class="panel">
                         ...
                         <div class="panel-body">
                                  <div class="row contentbody">
                                        ...
                                        <div class="col-sm-12">
                                            <p>Pemberi kerja :  <?php echo  $result->COMPANYNAME; ?></p> 
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body"> 
                            <label class="col-md-2" for="picture" style="padding: 0;margin: 0;">Berkas Pengesahan:</label> 
...
<?php }else{ ?>
  <form class="form-horizontal span6  wow fadeInDown" action="process.php?action=submitapplication&JOBID=<?php echo $result->JOBID; ?>"  enctype="multipart/form-data"  method="POST">
              ...
              <div class="col-sm-12">
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body"> 
                            <label class="col-md-2" for="picture" style="padding: 0;margin: 0;">Berkah Pengesahan: </label> 
                            <div class="col-md-10" style="padding: 0;margin: 0;">
                                <input id="picture" name="picture" type="file">
                                <input name="MAX_FILE_SIZE" type="hidden" value="1000000"> 
                            </div> 
          ...
          <div class="form-group">
            <div class="col-md-12"> 
                 <button class="btn btn-primary btn-sm pull-right" name="submit" type="submit" >kirimkan <span class="fa fa-arrow-right"></span></button>
              <a href="index.php" class="btn btn-info"><span class="fa fa-arrow-left"></span>&nbsp;<strong>Kembali</strong></a> 
            </div>
           </div>   
        </form> 
