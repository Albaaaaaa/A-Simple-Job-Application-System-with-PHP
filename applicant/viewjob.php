...
<div class="col-sm-12 content-body" >  
	...
	<div class="col-sm-6">
		<ul> 
            ...
            <li><i class="fp-ht-computer"></i>Sektor Lowongan Kerja : <?php echo $job->SECTOR_VACANCY; ?></li>
        </ul>
	</div>
	<div class="col-sm-12">
...
<p><i class="fa fa-paperclip"></i>  Tambahkan File</p>
	<div class="col-sm-12 slider">
		 <h3>Download Resume <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">Disini</a></h3>
	</div>  
	<div class="col-sm-12">
		<p>Pendapat</p>
